...
taskkill /F /FI "WINDOWTITLE eq Codebuff2OpenCode Proxy - Node.js Mode" /T >nul 2>&1
timeout /t 1 /nobreak >nul

title Codebuff2OpenCode Proxy - Node.js Mode
cd /d "%~dp0"

echo ==================================================
echo  Codebuff2OpenCode Proxy - Node.js Mode
